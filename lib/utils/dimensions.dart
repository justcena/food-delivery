...
class Dimentions {
  ...
  static double customHeight4 = screenHeight / 170.0;
  static double customHeight5 = screenHeight / 136.6;
  static double customHeight10 = screenHeight / 66.0;
  static double customHeight15 = screenHeight / 45.5;
